...
if __name__ == '__main__':
    ...
    for i in range(8001, n_games):
        ...
        print('episode ', i, 'score %.1f' % score, 'avg_score %.1f, ' % avg_score, "limit_factor %.2f" % limit_factor,  ", 0003, 0001, 378 100 update")

        if i % 500 == 0 and i > 1400:
            pickle.dump(agent, open( f"/content/drive/MyDrive/costum_rl_agents/SA_15rew_speed_10MSEandp1_sparEnvRew_cdfOnly_withMaxDiff_from3500_indexRew_100update_{i}.p", "wb" ) )
